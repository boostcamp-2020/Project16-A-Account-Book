...
import AccountImageTitleUpdate from '.';

export default {
  title: 'organisms/AccountImageTitleUpdate',
  component: AccountImageTitleUpdate,
};
...
export const AccountImageTitleUpdateDefault = () => {
  return (
    <GlobalThemeProvider>
      <AccountImageTitleUpdate account={temp} />
    </GlobalThemeProvider>
  );
};
